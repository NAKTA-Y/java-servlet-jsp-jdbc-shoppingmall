...
@MultipartConfig(
        ...
        location            = "/Users/nakta/resources/temp" // Multipart 임시 저장 파일 경로
)
...
public class FrontServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            req.setAttribute("status_code", e.getStatusCode());
            req.setAttribute("error_message", e.getErrorMessage());

            String errorPath = viewResolver.getPath("/error");
