...
public class DbUtils {
    ...
    static {
        ...
        basicDataSource.setUrl("jdbc:mysql://133.186.244.96:3306/nhn_academy_13");
        basicDataSource.setUsername("nhn_academy_13");
        basicDataSource.setPassword("EOcV(baaATcu3lny");
