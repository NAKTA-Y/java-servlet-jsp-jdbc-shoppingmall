...
<body>
<nav id="navbar"
     class="border-b-2 border-stone-300 fixed top-0 left-0 z-50 w-full py-4 bg-[#FBFBFB] transition duration-300 ease-in-out shadow-md dark:bg-neutral-600">
        ...
        <div class="relative flex items-center">
            ...
            <div
                ...
                <a
                    ...
                    <!-- User avatar -->
                    <img
                            src="${pageContext.request.contextPath}/resources/icon/user/user.png"
                            class="rounded-full"
